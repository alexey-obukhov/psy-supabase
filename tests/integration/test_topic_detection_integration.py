...
class TestTopicDetectionIntegration:
    ...
    def test_topic_detection_in_question_analysis(self, real_prompt_selector):
        ...
        for case in test_cases:
            ...
            if "expected_topics" in case:
                ...
                topic_match = any(exp_topic in topic.lower() or topic.lower() in exp_topic
                                for exp_topic in case["expected_topics"])
                assert topic_match, \
                    f"Expected one of {case['expected_topics']}, got '{topic}'"
            else:
    ...
    def test_extracted_topics_for_retrieval(self, integration_response_generator):
        ...
        for case in test_cases:
            ...
            if extracted_topics:
                ...
                primary_match = any(expected.lower() in primary_topic or primary_topic in expected.lower()
            ...
            if len(extracted_topics) > 1:
                ...
                found_secondary = any(any(expected.lower() in topic or topic in expected.lower()
                                        for expected in case["expected_secondary"])
                                    for topic in secondary_topics)

                assert found_secondary or primary_match, \
    ...
    def test_emotion_detection(self, real_prompt_selector):
        ...
        test_cases = [
            {
                "question": "I'm furious about how I was treated at work",
                "expected_emotion": "anger"
            },
            {
                "question": "I'm terrified of flying and have a trip coming up",
                "expected_emotion": "fear"
            },
            {
                "question": "I feel ashamed about what happened at the party",
        ...
        for case in test_cases:
            ...
            emotion_match = (
                case["expected_emotion"] in emotion.lower() or
                emotion.lower() in case["expected_emotion"]
            )
