...
from tests.conftest import DEFAULT_EMOTION, DEFAULT_TOPIC, create_text_generator_mocks, text_generator
...
class TestTextGenerator:
    ...
    def test_emotion_detection_happy(self, text_generator):
        ...
        with patch.object(text_generator, "_load_template", return_value=mock_template):
            with patch.object(
                text_generator,
                "generate_text",
                return_value="Generated happy response that demonstrates recognition of positive emotions and offers appropriate therapeutic support",
            ):
                ...
                result = text_generator.generate_therapeutic_response(
                    "I'm feeling really happy today!", "general_template", context
                )
    ...
    def test_emotion_detection_sad(self, text_generator):
        ...
        with patch.object(text_generator, "_load_template", return_value=mock_template):
            with patch.object(
                text_generator,
                "generate_text",
                return_value="Generated sad response that acknowledges feelings of sadness while providing compassionate validation and gentle support",
            ):
                # Mock emotion analysis
                text_generator.prompt_selector.analyze_question.return_value = {
                    "topic": "sadness",
                ...
                # Call the method under test
                result = text_generator.generate_therapeutic_response(
                    "I've been feeling down lately", "general_template", context
                )
    ...
    def test_emotion_detection_angry(self, text_generator):
        ...
        with patch.object(text_generator, "_load_template", return_value=mock_template):
            with patch.object(
                text_generator,
                "generate_text",
                return_value="Generated angry response that acknowledges feelings of anger while providing constructive coping strategies",
            ):
                # Mock PromptSelector
                mock_selector = Mock()
                mock_selector.analyze_question.return_value = {"topic": "anger", "emotion": "angry", "confidence": 0.9}
                ...
                result = text_generator.generate_therapeutic_response(
                    "I'm really frustrated with my situation", "general_template", context
                )
    ...
    def test_emotion_detection_anxious(self, text_generator):
        ...
        with patch.object(text_generator, "_load_template", return_value=mock_template):
            with patch.object(
                text_generator,
                "generate_text",
                return_value="Generated anxious response that helps identify anxiety triggers and suggests evidence-based coping strategies for managing worry",
            ):
                # Mock PromptSelector
                mock_selector = Mock()
                ...
                result = text_generator.generate_therapeutic_response(
                    "I'm worried about my upcoming presentation", "general_template", context
                )
    ...
    def test_neutral_emotion_handling(self, text_generator):
        ...
        result = text_generator.generate_therapeutic_response(
            "What's the weather like today?", "general_template", context
        )

        # Verify emotion was analysed correctly as neutral
        mock_selector.analyze_question.assert_called_once()
        assert DEFAULT_EMOTION in mock_selector.analyze_question.return_value.values()
        ...
        with patch.object(text_generator, "_load_template", return_value=mock_template):
            with patch.object(text_generator, "generate_text", return_value=realistic_response):
                ...
                context = {
                    ...
                    "psychological_context": {"emotion": "worried", "topic": "confidence"},
                }

                result = text_generator.generate_therapeutic_response(
                    "I'm worried about my confidence", "test_template", context
                )
    ...
    def test_conversation_history_integration(self):
        ...
        self.text_generator.generate_text.return_value = (
            "History: How can I improve my mood? I'm here to help with that."
        )

        # Call the method
        response = self.text_generator.generate_text(
            "How are you?", conversation_history=["How can I improve my mood?"]
        )
    ...
    def test_emotion_detection_with_complex_input(self, text_generator):
        ...
        with patch.object(text_generator, "_load_template", return_value=mock_template):
            with patch.object(
                text_generator,
                "generate_text",
                return_value="Complex emotion response addressing the mixed feelings about career advancement, balancing celebration of success with strategies for managing new responsibilities",
            ):
                ...
                result = text_generator.generate_therapeutic_response(complex_input, "general_template", context)
    ...
    def test_emotion_detection_integration(self, text_generator):
        ...
        with patch.object(text_generator, "_load_template", return_value=mock_template):
            with patch.object(text_generator, "generate_text", return_value=template_output):
                ...
                mock_selector.generate_category_info = Mock(
                    return_value={"Stress Management": 0.85, "Career Guidance": 0.75}
                )
                text_generator.prompt_selector = mock_selector
                ...
                result = text_generator.generate_therapeutic_response(
                    "I'm frustrated with my job", "test_template", context
                )
