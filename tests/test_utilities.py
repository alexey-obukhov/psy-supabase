...
def test_detect_repetition_pattern():
    ...
    # Call the function
    result = detect_repetition_pattern(original_question, current_question, similar_questions)
...
def test_detect_repetition_pattern_no_fixation():
    ...
    similar_questions = [{"question": "What makes me feel down?", "similarity": 0.78}]
...
def test_detect_repetition_pattern_only_common_words():
    ...
    similar_questions = [{"text": "What do I do now?", "similarity": 0.75}]
