...
from psy_supabase.utilities.utils_mapping import map_approach_to_template, APPROACH_TO_TEMPLATE
from psy_supabase.utilities.therapeutic_mappings import TherapeuticMappings
from psy_supabase.utilities.semantic_emotion_detector import get_emotion_mappings
...
class TestMappingConsistency:
    ...
    def test_pain_point_to_topic_consistency(self):
        ...
        for pain, expected_topic in expected_pain_to_topic.items():
            ...
            assert (actual_topic == expected_topic or 
        ...
        for topic, data in therapeutic_themes.items():
            if "emotions" in data:
                for emotion in data["emotions"]:
                    ...
                    assert emotion in emotion_mappings or any(emotion in e for e in emotion_mappings), \
    ...
    def _get_topic_from_pain_point(self, pain_point: str) -> str:
        ...
        # This should mirror the logic in your core code
